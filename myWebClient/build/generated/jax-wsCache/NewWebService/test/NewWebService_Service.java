 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://Test/", wsdlLocation = "http://localhost:8084/myWebService/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8084/myWebService/NewWebService?wsdl");
